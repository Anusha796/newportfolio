  ...
  <div class="container">
    ...
    <div class="about-grid">
      <div class="about-text">
        <p class="about-p">I'm a <strong>.NET Full Stack Developer</strong> with 3+ years of experience building scalable, high-performance web applications. I currently work at <strong style="color:#3b82f6">Infor (India) Pvt. Ltd.</strong> as a Software Engineer, developing the Infor CloudSuite Portal — a multi-tenant SaaS platform used by enterprises worldwide.</p>
        <p class="about-p">My core stack is <strong>ASP.NET Core 6</strong>, <strong>Angular 19</strong>, C#, SQL Server, and <strong>Microsoft Azure</strong>. I'm passionate about clean architecture, API design, and delivering software that performs at scale.</p>
        <p class="about-p">Before Infor, I spent 2.5 years at <strong>Capgemini Technology Services</strong> working on aircraft maintenance systems and enterprise deployments.</p>
      </div>
      <div class="info-card">
        <div class="ic-head">
...
.about-p{font-size:.92rem;color:#94a3b8;line-height:1.9;margin-bottom:1.1rem}
.about-p strong{color:#f8fafc}
...
.ic-head{display:flex;align-items:center;gap:.9rem;margin-bottom:1.2rem;padding-bottom:1.2rem;border-bottom:1px solid rgba(255,255,255,0.08)}
